    ...
    case 'Scheduled':
      return (
        <Box sx={{ mt: { xs: 3.75, sm: 3 } }}>
          ...
          <FilledButton sx={{ mt: 3, mb: 1.5 }}>Reschedule Move Out</FilledButton>
    ...
    case 'Completed':
      return (
        <Box sx={{ mt: 3.75 }}>
          ...
          <Box mt={1.5}>
            <Typography variant="body1" color="grey.500" mb={0.75}>
              YOUR MOVE OUT DAY:
            </Typography>
            <Typography variant="subtitle1" color="grey.400">
              {findValue(data, 'Info')}
          ...
          <Box sx={{ mt: 3 }}>
            ...
            <Card>
              ...
              <IconButton sx={{ backgroundColor: { xs: 'grey.800', sm: 'grey.900' }, p: 1.25 }}>
                <DownloadSVGIcon />
              </IconButton>
            </Card>
          </Box>
...
export const MoveOut = (data: RequestDetail) => (
